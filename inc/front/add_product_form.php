...
<form class="tsk-product-adder" method="post">
	...
	<p class="tsk-form-field">
		...
		<span class="tsk-field-wrp">
			<input type="text" id="tsk_add_title" name="add_prod[tsk_add_title]"  class="tsk-add-fild">
		</span>
	</p>
	...
	<p class="tsk-form-field">
		...
		<span class="tsk-field-wrp">
			<input type="number" step="0.01" id="tsk_add_summ" name="add_prod[tsk_add_summ]"  class="tsk-add-fild">
		</span>
	</p>
	...
	<p class="tsk-form-field">
		...
		<span class="tsk-field-wrp tsk-image-wrp">
			...
			<input type="hidden" name="add_prod[tsk_add_img]" id="tsk_image_url" value="">
	...
	<p class="tsk-form-field">
		...
		<span class="tsk-field-wrp">
			<select id="tsk_add_ptype" name="add_prod[tsk_add_ptype]" class="tsk-add-fild select short">
